...
<body class="d-flex flex-column">
    ...
    if (!empty($_POST)) {
        ...
        if (empty($data['title']))
            $data['title_err'] = 'Please choose title ';
        if (empty($data['eng_name']))
            $data['eng_name_err'] = 'Please enter your name';
        if (empty($data['mm_name']))
            $data['mm_name_err'] = 'Please enter name';
        if (empty($data['email']))
            $data['email_err'] = 'Please enter your email';
        if (empty($data['syllabus']))
            $data['syllabus_err'] = 'Please choose syllabus';
        if (empty($data['school']))
            $data['school_err'] = 'Please enter your school';
        if (empty($data['level']))
            $data['level_err'] = 'Please choose your level';
        if (empty($data['level1']))
            $data['level1_err'] = 'Please choose level';
        if (empty($data['marks']))
            $data['marks_err'] = 'Please enter your mark';
        if (empty($data['birthdate']))
            $data['birthdate_err'] = 'Please choose enter bitthday';
        if (empty($data['nationality']))
            $data['nationality_err'] = 'Please choose nationality';
    }
    //to connect database
    /* if ($valid) {
        ...
        <form class="form-horizontal" action="application.php" method="post">
            <div class="container">
                ...
                <div class="form-group">
                    ...
                    <div class="controls col-md-4">
                        ...
                        <?php if (!empty($data['title_err'])) : ?>
                            <span class="help-inline"><?= $data['title_err'] ?></span>
                        <?php endif; ?>
                    </div>
                </div>
                <br>
                <div class="form-group ">
                    ...
                    <div class="controls col-md-4">
                        <input name="eng_name" type="text" id="eng_name" class=" form-control form-control-inline is-invalid col-md-4" placeholder="Name in English">
                        <?php if (!empty($data['eng_name_err'])) : ?>
                            <span class="help-inline"><?= $data['eng_name_err'] ?></span>
                        <?php endif; ?>
                    </div>
                </div>
                <br>
                <div class="form-group ">
                    ...
                    <div class="controls col-md-4">
                        ...
                        <?php if (!empty($data['mm_name_err'])) : ?>
                            <span class="help-inline"><?= $data['mm_name_err'] ?></span>
                        <?php endif; ?>
                    </div>
                </div>
                <br>
                ...
                <div class="form-group ">
                    ...
                    <div class="controls col-md-4">
                        ...
                        <?php if (!empty($data['email_err'])) : ?>
                            <span class="help-inline"><?= $data['email_err'] ?></span>
                        <?php endif; ?>
                    </div>
                </div>
                <br>
                <div class="form-group">
                    ...
                    <div class="controls col-md-4">
                        ...
                        <?php if (!empty($data['syllabus_err'])) : ?>
                            <span class="help-inline"><?= $data['syllabus_err'] ?></span>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="form-group ">
                    ...
                    <div class="controls col-md-4">
                        ...
                        <?php if (!empty($data['school_err'])) : ?>
                            <span class="help-inline"><?= $data['school_err'] ?></span>
                        <?php endif; ?>
                    </div>
                </div>
                <br>
                <div class="form-group">
                    ...
                    <div class="controls col-md-4">
                        ...
                        <?php if (!empty($data['level_err'])) : ?>
                            <span class="help-inline"><?= $data['level_err'] ?></span>
                        <?php endif; ?>
                    </div>
                </div>
                <br>
                <div class="form-group">
                    ...
                    <div class="controls col-md-4">
                        ...
                        <?php if (!empty($data['level1_err'])) : ?>
                            <span class="help-inline"><?= $data['level1_err'] ?></span>
                        <?php endif; ?>
                    </div>
                </div>
                <br>
                <div class="form-group ">
                    ...
                    <div class="controls col-md-4">
                        ...
                        <?php if (!empty($data['marks_err'])) : ?>
                            <span class="help-inline"><?= $data['marks_err'] ?></span>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="form-group ">
                    ...
                    <div class="controls col-md-4">
                        ...
                        <?php if (!empty($data['birthdate_err'])) : ?>
                            <span class="help-inline"><?= $data['birthdate_err'] ?></span>
                        <?php endif; ?>
                    </div>
                </div>
                <br>
                <div class="form-group ">
                    ...
                    <div class="controls col-md-4">
                        ...
                        <?php if (!empty($data['nationality_err'])) : ?>
                            <span class="help-inline"><?= $data['nationality_err'] ?></span>
                        <?php endif; ?>
                    </div>
